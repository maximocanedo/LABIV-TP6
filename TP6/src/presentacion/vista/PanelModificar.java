...
public class PanelModificar extends JPanel {
	...
	public PanelModificar() {
		...
		JLabel lblModificarUnRegistro = new JLabel(Messages.getString("modificarRegistroTitle")) {{ //$NON-NLS-1$
			setFont(Styles.FONT_TITLE);
		}};
		add(lblModificarUnRegistro, "cell 0 0 4 1,alignx center");
		
		JLabel lblSeleccioneElRegistro = new JLabel(Messages.getString("seleccioneRegistroSubtitle")) {{ //$NON-NLS-1$
		...
		JLabel lblNewLabel = new JLabel(Messages.getString("nombreDosPuntos")) {{ //$NON-NLS-1$
			setFont(Styles.FONT_DEFAULT);
		}};
		...
		JLabel lblDniN = new JLabel(Messages.getString("dniDosPuntos")) {{ //$NON-NLS-1$
			setFont(Styles.FONT_DEFAULT);
		}};
		...
		btnModificar = new JButton(Messages.getString("modify")) {{ //$NON-NLS-1$
			setFont(Styles.FONT_DEFAULT);
		}};
